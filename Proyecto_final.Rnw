...
stargazer(vars1,title = "Medidas estad\'isticas", label="stats", summary.stat = c("n", "median"))
@
...
paleta='blue'
hist(datos_colombia$restoLog,main=title,
        col=paleta,ylim = c(0,25),
        ylab = "%")
###
...
paleta='blue'
hist(datos_colombia$totalLog,main=title,
        col=paleta,ylim = c(0,25),
        ylab = "%")
@
\caption{Histogramas}
